...
# time.sleep(1)
#
# driver.find_element(By.ID, "AKCSearch").clear()
# for i in football_list:
#     driver.find_element(By.ID, "AKCSearch").send_keys(i)
#     time.sleep(1)
#     driver.find_element(By.XPATH, '//*[@id="searchre"]/fieldset/div[1]/button').click()
#     time.sleep(3)
#     try:
#         a = driver.find_element(By.CLASS_NAME, 'top5_price')
#         b = a.text
#     except:
#         continue
#     print(b)
